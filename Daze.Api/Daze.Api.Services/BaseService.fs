...
let [<Literal>] ConnectionString = "host=35.187.43.156;database=daze_db;password=swords$online$99;username=daze;Timeout=1000;pooling=True;"
let [<Literal>] ConnectionNameString = ""
let [<Literal>] IndividualsAmount = 1000
let [<Literal>] UseOptionTypes = true
//let [<Literal>] ResolutionPath = __SOURCE_DIRECTORY__ + @"/../packages/Npgsql.3.1.10/lib/netstandard1.3/Npgsql.dll"
let [<Literal>] ResolutionPath = __SOURCE_DIRECTORY__ + @"/../packages/Npgsql.3.1.10/lib/netstandard1.3/"
