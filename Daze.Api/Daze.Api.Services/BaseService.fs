...
let [<Literal>] ConnectionString = "host=35.187.43.156;database=daze_db;password=swords$online$99;username=daze;timeout=600;commandtimeout=5000;pooling=True;minpoolsize=1"
